    ...
    return {
        ...
        link: function (scope, element, attrs, controller) {
            ...
            element[0].onkeyup = function (e) {
                ...
                // Do Search
                if (search_string.length < 2 || search_string.length > 20) {
                    scope.visible = false;
                    //unmanaged code needs to force apply
                    scope.$apply();
                    return;
            ...
            var template = "<ul id='autoComplateList' ng-show='visible' ng-style=\"{'top':top,'left':left,'width':width}\" class='searchresultspopup'><li ng-class=\"{ 'selected' : isSelected($index) }\" ng-click='select($index)' ng-repeat='result in results'>" + itemTemplate + "</li></ul>";
